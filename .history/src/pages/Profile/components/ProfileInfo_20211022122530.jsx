  ...
  return (
    <div className="tab1" style={{ display: "none" }}>
      ...
      <label>
        ...
        <input onChange={handleInputChange}  name="name" value={form.name} type="text" placeholder="0949******" />
      </label>
      <label>
        <p>Email<span>*</span></p>
        <input onChange={handleInputChange}  name="name" value={form.name} defaultValue="vuong.dang@dna.vn" disabled type="text" />
      </label>
      <label>
