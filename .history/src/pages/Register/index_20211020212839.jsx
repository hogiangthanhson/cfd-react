...
export default function Register() {
  ...
  const handleInputChange = (e) => {
    const {name, value} = e.currenTarget
    setForm({
      ...form,
      [name]: value,
    });
          ...
          <div className="wrap container">
            ...
            <div className="form">
              ...
              <label className="disable">
                <p>Sử dụng COIN</p>
                <div className="checkcontainer">Hiện có <strong>300 COIN</strong>
              ...
              <label>
                <p>Ý kiến cá nhân</p>
                <input onChange={handleInputChange} name="des" value={form.des} type="text" placeholder="Mong muốn cá nhân và lịch bạn có thể học."/>
              </label>
              <div className="btn main rect" onSubmit={submit}>đăng ký</div>
            </div>
          </div>
        </div>
      </section>
